    ...
    if (
      ...
      if (data.user) {
        ...
        if (email) {
          ...
          formdata.append("service", "print_media");
    ...
    <div className="h-full min-h-screen w-full pt-14 px-10">
      ...
      <div className="bg-blue grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 h-full w-full mt-20 gap-4 pb-20 ">
        <div className="flex flex-col justify-between bg-blue-600 rounded-lg h-72  shadow-md">
          ...
          <button
            onClick={() => apply("Graphic Designing")}
            className="bg-blue-100 text-gray-800 bg-opacity-60 shadow-xl py-4"
          >
            Apply Now
          </button>
        </div>
        <div className="flex flex-col justify-between bg-blue-500 rounded-lg h-72  shadow-md">
          ...
          <button
            onClick={() => apply("Product labelling")}
            className="bg-blue-100 text-gray-800 bg-opacity-60 shadow-xl py-4"
          >
            Apply Now
          </button>

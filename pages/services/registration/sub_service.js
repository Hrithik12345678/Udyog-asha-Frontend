...
export const sub_services = () => {
  ...
  useEffect(async () => {
    if (pid && ss) {
      const res = await axios.post(
        "http://localhost:5000/service/subservdata",
        {
          pid: pid,
          name: ss,
        }
  ...
  return (
    <div className="bg-black bg-opacity-80 flex justify-center pt-14   min-h-screen w-full h-full">
      {loading == true && (
        <div className=" flex justify-center z-20 fixed bg-black bg-cover h-full w-full bg-opacity-40 min-h-screen  min-w-full">
                ...
                <div className="bg-white " key={data.name}>
                  <div className=" ">
                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 px-10 mt-4 gap-y-6 justify-items-stretch gap-x-10">
                ...
                <div className="bg-white " key={data.name}>
                  <div className=" ">
                    ...
                    >
                      ...
                      <div className="h-1 w-10 rounded-full  bg-yellow-900 mt-1 mx-10"></div>
                      <div className="grid grid-cols-1 md:grid-cols-2 px-10 mt-4 gap-y-6 justify-items-stretch gap-x-10">
